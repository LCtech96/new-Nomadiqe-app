-- Query SQL corretta per creare le tabelle NextAuth su Supabase
-- Esegui questa query completa nel SQL Editor di Supabase

-- 1. Crea la tabella accounts (se non esiste)
...
-- 2. Crea la tabella sessions (se non esiste)
